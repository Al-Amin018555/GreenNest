            ...
            <div className="hero bg-base-200 min-h-screen">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <div className="text-center lg:text-left">
                        ...
                        <p className="py-6">
                            Register for GreenNest to explore beautiful indoor plants, learn how to care for them, and manage everything from your personal profile.
                        </p>
                    </div>
                    <form onSubmit={handleSubmit(onSubmit)} className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
                        <div className="card-body">
                            <fieldset className="fieldset">
                                ...
                                <button className="btn bg-[#6f9349] hover:bg-[#0b4f16] text-white font-semibold mt-4">Register</button>
                                <button type="button" onClick={handleGoogleLogin} className="btn mt-2 bg-[#6f9349] hover:bg-[#0b4f16] text-white font-semibold w-full">
