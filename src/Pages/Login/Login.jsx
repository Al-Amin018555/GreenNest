            ...
            <div className="hero min-h-screen">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <div className="text-center lg:text-left">
                        ...
                        <p className="py-6">
                            Log in to your GreenNest account to explore premium indoor plants, access detailed care guides, and manage your profile with ease.
                        </p>
                    </div>
                    <form onSubmit={handleSubmit(onSubmit)} className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
                        <div className="card-body">
                            <fieldset className="fieldset">
                                ...
                                <button className="btn bg-[#6f9349] hover:bg-[#0b4f16] text-white font-semibold mt-4">Login</button>
                                {/* Google Login */}
